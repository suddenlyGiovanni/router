...
export default class Router implements Types.Router {
		...
		public all(path: Types.PathParams, ...handlers: Types.RouteHandler[]): Router;
		public all(path: Types.PathParams, ...handlers: Types.RequestHandlerParams[]): Router;
		public all(path:Types.PathParams, ...handlers: Function[]): Router {
				let route = this.route(path)
